    ...
    <div className="max-w-xl sm:max-w-2xl md:max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center space-y-2">
        <div className="flex items-center justify-center gap-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold">Farmer's AI Assistant</h1>
        </div>
      ...
      {results.posts.length > 0 && (
        <Card className="p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">AI Response</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {results.posts.map((post, index) => (
              <PostCard key={index} post={post} userRole={userRole} handleMediaClick={handlePostClick} />
            ))}
          </div>
        </Card>
      )}
      ...
      {results.workShops.length > 0 && (
        <Card className="p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Upcoming Workshops</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">

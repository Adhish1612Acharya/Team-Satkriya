      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p>
              Connecting healthcare professionals, NGOs, volunteers, and researchers
              to make a difference in healthcare accessibility.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a href="mailto:contact@example.com" className="flex items-center space-x-2 hover:text-indigo-400">
